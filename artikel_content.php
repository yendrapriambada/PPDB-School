<?php
    ...
    //select join table mahasiswa dengan prodi
    $row = query("SELECT * FROM artikel WHERE id=$id")[0];
?>
...
<head>
    ...
    <title>Artikel - SMAN 5 Ambis</title>
    ...
    <link rel="stylesheet" href="StyleScript/style-artikel.css">
    <link rel="stylesheet" href="StyleScript/ads.css">
     
</head>
<body>
<header style="background-image: url(Asset/asset-images/8OynRGNt6uI.png);">
        <div class="headline">
    ...
    <section class="container">
        <p><b style="color: #38687F; font-size: 40px;">Artikel</b></p>
        <p id="garis"></p>

        <!-- CONTENT ARTIKEL/NEWS -->
        <div class="grid-artikel">
            ...
            <div class="sidebar">
                ...
                <ul class="b">
                    <a href="artikel_content.php?id=<?= $row["id"];?>" style="text-decoration: none; color: #38687F"><li style="text-align: justify;"><?= $row["judul"]; ?></li></a>
                </ul>
                <?php endforeach; ?>
            </div>
            <div class="content-1">
                <center><img src = "halaman_admin/img_artikel/<?= $row["foto"]; ?>" class="atur-img" alt="konten"></center>
            </div>
